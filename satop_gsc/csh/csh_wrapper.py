...
slash_waitfunc_t = ctypes.CFUNCTYPE(ctypes.c_int, ctypes.POINTER(slash_t), ctypes.c_uint)
...
slash_completer_func_t = ctypes.CFUNCTYPE(None, ctypes.POINTER(slash_t), ctypes.c_char_p)
...
slashlib = ctypes.CDLL(os.path.join(
